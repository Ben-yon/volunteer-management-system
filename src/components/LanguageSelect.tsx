  ...
  return (
    <div className="flex space-x-1">
      <select
        ...
        className="w-[80px] lg:w-[80px] text-[18px] leading-[24.2px]  md:w-[80px] md:text-[18px] md:leading-[24.2px] sm:w-[75px] sm:text-[16px] sm:leading-[24.2px]  xsm:w-[65px] xsm:text-[14px] xsm:leading-[16.2px] focus:outline-none bg-transparent"
      >
