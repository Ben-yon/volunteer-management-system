      ...
      <div className="flex">
        ...
        <div className="flex w-[486px] h-[379px] rounded-[20px] bg-[#F9F9F9] home-chat-shadow ml-[26px]">
          <div className="ml-[67px] mt-[34px]">
            <h2 className="text-dashboard-home text-[15px] font-[700] leading-[18.15px]">
              New Messages
            </h2>
            <div className="flex items-center justify-center mt-[25px]">
              ...
              <div className="flex flex-col space-y-1">
                <p className="text-dashboard-home font-[500] text-[9px] leading-[10.89px] ">
                  08:30 AM
                </p>
                <span className="text-primary ml-[30px] flex items-center justify-center bg-dashboard-home w-[10px] h-[10px] text-[6px] leading-[7.26px] font-[500] rounded-full">
                  2
                </span>
              </div>
            </div>
