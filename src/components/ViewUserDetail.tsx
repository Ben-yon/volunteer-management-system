    ...
    return (
        <div className="relative bg-details bg-no-repeat bg-cover filter md:filter-none z-0 w-[100%] h-[1117px]">
            <div className="red-gradient bg-no-repeat bg-cover w-[100%] h-[1117px]">
                ...
                <div className="relative flex flex-col items-center justify-center top-28 w-[680px] h-[752.56px] white-gradient rounded-[67.49px] opacity-100 m-auto">
                    ...
                    <div className="items-center">
                        <div>
                            <img src={imageState.previewSrc} alt="" className={imageState.previewSrc ? `${styles.imageUploader} mb-2 ml-14` : ''} />
                        </div>
                        ...
                        <p className="text-primary text-center text-2xl">{ formData?.daysOfMonth } { formData.daysOfMonth ? <span>Days per Month</span> : ""} </p>
                    ...
                    <button className="rounded-full w-[10px] h-[10px] p-4 bg-primary mt-[16.03px] font-bold flex  justify-center items-center">&lt;</button>
                </div>
