    ...
    <div className="relative bg-admin bg-no-repeat bg-cover filter md:filter-none z-0 w-[100%] h-[100vh]">
      ...
      <div className="absolute top-8 right-16 z-10 text-black hidden space-x-1 md:absolute md:top-[39px] md:right-[47px] sm:top-[33px] xsm:top-[18px] xsm:right-[32.1px]">
        ...
        <div className="flex flex-col justify-center items-center min-h-screen">
          ...
          <button className="w-[200.21px] h-[75.37px] rounded-[20px] bg-admin-secondary font-bold text-[22px] leading-[26.63px] text-primary mt-3 lg:w-[200.21px] lg:h-[75.37px] lg:rounded-[20px] lg:text-[22px] lg:leading-[26.63px] md:w-[140.19px] md:h-[52.78px] md:rounded-[16.49px] md:text-[18.14px] md:leading-[21.96px] md:mt-[29.69px] sm:w-[140.19px] sm:h-[52.78px] sm:rounded-[16.49px] sm:text-[18.14px] sm:leading-[21.96px] sm:mt-[29.69px] xsm:w-[62.31px] xsm:h-[23.46px] xsm:rounded-[7.33px] xsm:text-[8.06px] xsm:leading-[9.76px] xsm:mt-[13.2px]">
            Open Email
          </button>
